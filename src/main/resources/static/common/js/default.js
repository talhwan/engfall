...
function getSprExceptionMsg(obj_param){
	...
	let index0 = stringTrace.indexOf("com.thc.sprboot.exception.SprException");
	let index1 = stringTrace.indexOf("\\r");
	let tempStringTrace = stringTrace.substring(index0, index1);
	tempStringTrace = tempStringTrace.replace("com.thc.sprboot.exception.SprException: ", "");
...
function listener_img_transparent(obj_this) {
	$(obj_this).attr("src", "/resources/common/img/img_transparent.png")
}